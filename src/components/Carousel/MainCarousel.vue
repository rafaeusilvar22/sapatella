<template>
  <div class="relative flex min-h-screen">
    <div
      ...
      :key="index"
      class="w-full md:w-1/2 min-h-[400px] md:min-h-screen bg-cover object-contain bg-center invisible md:visible"
      :style="{ backgroundImage: `url(${image})` }"
    ></div>

    <button
      class="swiper-button-prev sap-main-carousel-custom-prev hover:bg-secondary-300 left-8 hidden md:block"
    >
      <img
    ...
    <button
      class="swiper-button-next sap-main-carousel-custom-next hover:bg-secondary-300 right-8 hidden md:block"
    >
      <img
